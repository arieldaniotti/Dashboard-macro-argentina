...
# ==========================================
# 5. CEREBRO IA (Gemini - Prompt Mejorado)
# ==========================================
...
REGLA DE ORO: NO repitas los números crudos en el texto, el cliente ya los está viendo en el tablero. Tu trabajo es INTERPRETAR el por qué.

Redactá un "Flash de Mercado" de 3 párrafos cortos (Estilo Bloomberg/Wall Street Journal, tono sofisticado, crudo y directo, sin markdown):
1. Panorama Global: Analizá los drivers detrás del mercado hoy. Relacioná los movimientos del S&P, Oro y Petróleo con el contexto geopolítico actual (riesgos de escaladas bélicas, Medio Oriente, Rusia-Ucrania) y las expectativas de tasas de la FED.
2. Panorama Argentina: Analizá la coyuntura local. Explicá qué significa el nivel actual del Riesgo País y la Brecha Cambiaria en relación a la política fiscal del gobierno, reservas del BCRA, cepo cambiario y liquidación del agro.
3. Proyección/Alerta: Una frase final contundente sobre qué variable clave vigilar mañana.
"""
